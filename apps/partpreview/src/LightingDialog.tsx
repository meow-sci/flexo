...
import { Dialog, DialogHeader, ListBoxItem, Modal, Select, Slider } from '../../../src/ui/kit'
...
/**
 * The numeric lighting knobs, in a dismissable modal rather than inline in the
 * settings menu: a react-aria `Menu` owns pointer/keyboard for its items, so a
 * slider inside the collection is unsupported.
 *
