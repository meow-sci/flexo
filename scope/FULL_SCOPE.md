...
| **Static objects** (launch pads / surface complexes — `apps/icrp`)                        | [static-objects.md](static-objects.md)                             | `StaticObjectTemplate.cs`, `StaticSubObjectTemplate.cs`, `StaticSubObjectInstance.cs`, `StaticObject(Model\|Renderer).cs`, `KSA.GlbImport/StaticObjectAssetBundler.cs`, `CoreLaunchPad*` XML, `Shaders/Mesh/StaticObject.*`                                                                                                  | 🆕 modeled @5348 (the build that introduced them) — parser/serializer byte-faithful to the bundler (golden tests over vendored fixtures); assembly frame +X up/+Y east/+Z north; `<Alpha>`/`<Terrain>` modeled here (closing T1/T2 for the static surface); vessel-mesh reuse by global id ⏳ [V1]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Launch sites & system mods** (`apps/icrp` site export)                                  | [launch-sites.md](launch-sites.md)                                 | `LocationReference.cs`, `LandmarkReference.cs`, `DecalModifierReference.cs`, `SystemTemplate.cs`, `Mod.cs`/`ModManifest.cs`, `Astronomicals.xml`, `SolSystem.xml`                                                                                                                                                            | 🆕 modeled @5348 — a mod cannot patch a Core body (first-wins silent drop), so sites ship as a self-contained `<System>` with inline body clones (landmarks + terrain decals injected; textures by id-reference); `AltitudeOffset Km=` is metres; stock-pad GameData append = the only partial hook; ⏳ [V2][V5][V6]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
